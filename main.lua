...
UILabel("2. 请将体积较大的鱼收起以便更容易找到红心。",16,"left","230,50,92")
UILabel("3. 每秒点击次数最好不要超过40次，否则游戏会卡死",16,"left","230,50,92")
UILabel("4. 游戏攻略、问题反馈请加群:414534539",16,"left","230,50,92")
UIShow()
